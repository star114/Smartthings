...
metadata {
    definition(name: "SmartSense Temp/Humidity Sensor (Patched by star114)", namespace: "star114", author: "SmartThings/iquix/star114", ocfDeviceType: "oic.d.thermostat", vid: "SmartThings-smartthings-Xiaomi_Temperature_Humidity_Sensor" {
...
def parse(String description) {
    ...
    if (!map) {
        ...
        map.value = parseTemperature(description)
