...
/*
 *    2020/09/17 >>> v0.1.0 - forked
 *    2020/05/22 >>> v0.0.16 - Explicit displayed flag
 *    2019/04/28 >>> v0.0.15 - Updarte reference table
 */

metadata {
    definition (name: "SmartWeather Station For Korea", namespace: "star114", author: "Booung/star114", ocfDeviceType: "x.com.st.d.airqualitysensor") {
