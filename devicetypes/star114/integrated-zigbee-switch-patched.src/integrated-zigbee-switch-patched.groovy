 ...
 *  under the License.
 *
 *  author : woobooung@gmail.com / star114
 */
public static String version() { return "v0.0.23.20200810" }
/*
 *   2020/08/10 >>> v0.0.22.20200810 - modified by star114
...
metadata {
    definition(name: "Integrated ZigBee Switch (Patched)", namespace: "star114", author: "Booung/star114", ocfDeviceType: "oic.d.switch", vid: "generic-switch") {
        capability "Actuator"
        ...
        // Unclear devices without model, manufacturer
        // Hej-Home GQ 3 way Switch (no model and manufacturer
